...
This guide is recommended for those who have:
 * Not completed COMP1531 in the last few years; or
 * Do not feel they have adequate confidence in the basic usage of `git`
...
3. To add your key to GitLab go to https://nw-syd-gitlab.cseunsw.tech/-/profile/keys
...
To make the actual clone, navigate to the directory where you want to store related exercises and run the following commands:

```
$ git clone <URL YOU COPIED>
$ cd lab0 # To navigate into the directory
```
