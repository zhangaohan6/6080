  ...
  return (
    <>
      ...
      <nav className="nav-bar">
        <div className="nav-item" onClick={() => setPageType(0)}>
          Home
        </div>
        <div className="nav-item" onClick={() => setPageType(1)}>
          Pricing
        </div>
        <div className="nav-item" onClick={() => setPageType(2)}>
          FAQ
        </div>
        <div className="nav-item" onClick={() => setPageType(3)}>
          Gallery
        </div>
      </nav>
